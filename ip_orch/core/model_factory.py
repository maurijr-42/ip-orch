...
class ModelFactory:
    ...
    def create(cls, model_name: str, device: Optional[str] = None, models_path: Optional[str] = None) -> Any:
        ...
        if key == "nequip_oam_xl":
            ...
            path = os.path.join(base_path, "nequip", "nequip-OAM-XL.nequip.pt2")
        ...
        if key == "nequip_oam_l":
            ...
            path = os.path.join(base_path, "nequip", "nequip-OAM-L.nequip.pt2")
            return NequIPCalculator.from_compiled_model(compile_path=path, device=device)
        ...
        if key == "dpa_3_1_3m_ft":
            ...
            path = os.path.join(base_path, "deepmd", "dpa3-openlam.pth")
        ...
        if key == "nequip_mp_l":
            ...
            path = os.path.join(base_path, "nequip", "nequip-MP-L.nequip.pt2")
            return NequIPCalculator.from_compiled_model(compile_path=path, device=device)
        ...
        if key == "allegro_mp_l":
            ...
            path = os.path.join(base_path, "nequip", "allegro-MP-L.nequip.pt2")
            return NequIPCalculator.from_compiled_model(compile_path=path, device=device)
        ...
        if key == "dpa_3_1_mptrj":
            ...
            path = os.path.join(base_path, "deepmd", "dpa3-mptrj.pth")
            return DP(model=path)
